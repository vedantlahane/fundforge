...
export function ProjectMilestones({ projectId, isEmbedded = false }: ProjectMilestonesProps) {
        ...
        <div key={milestone.id} className="flex gap-4">
          <div className="flex flex-col items-center">
            ...
            {index < project.milestones.length - 1 && (
              <div className={`w-0.5 flex-1 min-h-[3rem] mt-2 ${milestone.status === "completed" ? "bg-purple-500/50" : "bg-border"}`} />
            )}
          </div>
